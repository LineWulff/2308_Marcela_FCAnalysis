...
#### —- Running UMAP —-
    ...
    ##      UMAP_1      UMAP_2
    ## 1 -8.413934  2.39472377
    ## 2 -1.861578 -0.03326239
    ## 3 -2.479629  3.19303453
    ## 4  3.342056  0.55270469
    ## 5  4.647659  1.21285224
    ## 6 -1.088001 -9.69633377
    ...
    ## Warning: Removed 1204 rows containing non-finite values (`stat_density2d()`).
...
![](2308_CD45pos_files/figure-markdown_strict/unnamed-chunk-4-1.png)
    ...
    ## Warning: Removed 1204 rows containing non-finite values (`stat_density2d()`).
    ## Removed 1812 rows containing missing values (`geom_point()`).
    ...
    ## Warning: Removed 203 rows containing non-finite values (`stat_density2d()`).
    ## Removed 1812 rows containing missing values (`geom_point()`).
...
![](2308_CD45pos_files/figure-markdown_strict/unnamed-chunk-4-2.png)
    ...
    ## Warning: Removed 405 rows containing non-finite values (`stat_density2d()`).
    ## Removed 1812 rows containing missing values (`geom_point()`).
...
![](2308_CD45pos_files/figure-markdown_strict/unnamed-chunk-4-3.png)
    ...
    ## Warning: Removed 608 rows containing non-finite values (`stat_density2d()`).
    ## Removed 1812 rows containing missing values (`geom_point()`).
